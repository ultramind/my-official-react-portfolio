...
const Contact = () => {
  return (
    <div className="p-2 mt-20 mb-16">
      ...
      <div className="cardContainer p-2 w-full">
        <div className="card mt-10 flex-col space-y-12">
          <div className="p-4 space-y-4 shadow-default rounded-lg">
          ...
          <div class="card shadow-default flex-col p-8 space-y-6 rounded-xl">
